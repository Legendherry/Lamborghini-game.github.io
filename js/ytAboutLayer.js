var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"L: I wonder who the programmer of this game is?",
			"E: Me, I'm Adeola A.k.a Legend Herry.",
			"G: Ok, where is the material from?",
			"E: To be honest, the material is from the Internet. I think I need to say 'thanks' to these authors.",
			"N: And would you mind tell me some technical information about this game?",
			"D: Not at all. This game is based on HTML5 and HTML5 game engine lufylegend.js.",
